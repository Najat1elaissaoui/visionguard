...
import 'package:visionguard/repositories/auth_repository.dart';
...
class AuthViewModel extends ChangeNotifier {
  ...
  Future<bool> signUp(String username, String email,String num , String password) async {
    _isLoading = true;
    _errorMessage = null;
    notifyListeners();
    ...
    try {
      final result = await _authRepository.signUp(
          username: username, email: email,num:num, password: password);
      if (result == "success") {
        _isAuthenticated = true;
        fetchUserProfile();
        return true;
